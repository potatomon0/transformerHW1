...
let majorContainer = {//object created for things that will replace what's on the page
    mens: {
        ...
        optionTags: ["Seakers","Boots", "Flannels", "Rugged Wear", "Shaving Cream"],
    ...
    womens: {
        ...
        productImages:[
            {name:"t shirt",pic:"https://www.helikon-tex.com/media/catalog/product/cache/6/image/500x/17f82f742ffe127f42dca9de82fb58b1/T/S/TS-TSW-CO-t-shirt_damski_-_bawena-11-1000_1.jpg"},
            {name:"pants",pic:"https://underarmour.scene7.com/is/image/Underarmour/PS1362772-001_HF?rp=standard-0pad|pdpMainDesktop&scl=1&fmt=jpg&qlt=85&resMode=sharp2&cache=on,on&bgc=F0F0F0&wid=566&hei=708&size=566,708"},
            {name:"shoes",pic:"https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/f820e398-3050-438b-91a9-e985898def17/spark-womens-shoes-w4WdlF.png"}
        ]
    },
    kids: {}
}
...
const changeOptions = () => {//function thats called within changeAll() with onclick in html
    majorContainer.mens.optionTags.forEach((tagname) => {//forEach loops through the optionTags ("Sneakers","Boots","Flannels",...etc)
